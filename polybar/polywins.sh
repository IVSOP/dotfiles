...
# SETTINGS {{{ ---
mapfile -t colors < $HOME/.config/polybar/current-theme/polywins-colors

active_text_color=${colors[0]}
active_bg=${colors[1]}
active_underline=${colors[2]}

inactive_text_color=${colors[3]}
inactive_bg=
inactive_underline=${colors[4]}
